...
/*
    ...
    2) call zero or more "non-terminal" operations on the stream
        * non-terminal operations add processing steps to the stream, but do not actually start the iteration
    ...
    3) call a terminal operation on the stream
        * terminal operations start the iteration of the stream and processing of each element
...
public class JavaStreams {
    public static void main(String[] args) throws IOException {
        ...
        String bandsFile = "/Users/ryandesmond/Documents/CodingNomads/ONLINE/java/java_fundamentals/src/labs_examples/testing/Streams/bands.txt";
        String dataFile = "/Users/ryandesmond/Documents/CodingNomads/ONLINE/java/java_fundamentals/src/labs_examples/testing/Streams/data.txt";
